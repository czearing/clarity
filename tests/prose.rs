...
///
/// This was 66 before the generator was rebuilt on the framework's own searches. That work
/// replaced two passes with one and wrote several files of prose explaining why, and the reader
